...
CREATE TABLE `tenants` (
  ...
  `schema_password` varchar(100) NOT NULL DEFAULT 'my5ql2021',
...
(1,'default','default','fineract_default','Africa/Nairobi',NULL,NULL,NULL,NULL,'mifos-db-server','3306','root','my5ql2021',1,5,30000,1,60,1,50,1,40,20,10,60,34000,60000);
